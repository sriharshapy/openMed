#!/usr/bin/env python3
"""
ResNet50 GradCAM Visualization Script for TB Detection
...
def apply_gradcam_to_images(model, dataset, device, samples_per_class=5, save_dir="./gradcam_results/resnet50_tb"):
...
def main():
    ...
    config = {
        ...
        "save_dir": "./gradcam_results/resnet50_tb"
    }
    
    print("=== ResNet50 GradCAM Visualization for TB Detection ===")
    ...
    try:
        ...
        print(f"❌ Error: {e}")
        print("Make sure you have trained the model first using resnet50_tb.py")
        return
    ...
    print("\nGradCAM shows which parts of the chest X-rays the model focuses on for TB classification.")
    print("Red areas indicate high importance, blue areas indicate low importance.")
    print("Files are saved as: gradcam_normal_1.png, gradcam_normal_2.png, gradcam_tuberculosis_1.png, etc.")
